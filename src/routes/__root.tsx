...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Folio — Digital Catalog Reader" },
      { name: "description", content: "Browse beautiful PDF catalogs in a realistic flipbook experience." },
      { name: "theme-color", content: "#8b7355" },
      { property: "og:title", content: "Folio — Digital Catalog Reader" },
      { property: "og:description", content: "Browse beautiful PDF catalogs in a realistic flipbook experience." },
